...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/alicekubicki/istota/main/deploy/install.sh -o install.sh
...
REPO_URL="${ISTOTA_REPO_URL:-https://github.com/alicekubicki/istota.git}"
