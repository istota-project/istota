...
Temporary facts (e.g., "staying_in lisbon") coexist with permanent facts and
...
def add_fact(
    ...
    # statements about the same object (e.g. `acquired arc desk lamp` vs
    # `disposed_of arc desk lamp`) and silently drops the second.
    #
