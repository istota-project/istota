...
- **Fast** — under about 30 changed lines, one or two files, no boundary surface. Implement, add or extend one test, run the affected tests, then the verification pass below once, commit. No pre-written failing test, and no review.
