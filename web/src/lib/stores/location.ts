...
export const mapFlyTo = writable<((lat: number, lon: number, zoom?: number) => void) | undefined>(
  undefined,
);
...
export const onPlaceMove = writable<
  ((placeId: number, lat: number, lon: number) => void) | undefined
>(undefined);
