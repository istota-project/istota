...
class TestLoadBudget:
    ...
    # Raised from 675 for ISSUE-270, which adds a credential preflight to the
    # job lifecycle. The old ceiling had one line of headroom left, so it was
    # saturated rather than comfortable — any further work on these three
    # bodies would have tripped it. Raise this deliberately and say what for;
    # the number exists to catch growth nobody noticed, not to freeze the
    # documents.
    BUDGET_LINES = 685
