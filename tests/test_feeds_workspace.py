...
class TestSynthesizeFeedsContext:
    ...
    def test_explicit_data_dir(self, tmp_path):
        ...
        ctx = synthesize_feeds_context("alice", tmp_path, data_dir=explicit)
