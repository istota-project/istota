...
class TestFactSimilarity:
    def test_identical_strings(self):
        assert _fact_similarity("allergic_to sesame seeds", "allergic_to sesame seeds") == 1.0
...
class TestFuzzyDedup:
    ...
    def test_near_duplicate_skipped(self, conn):
        ...
        id1 = add_fact(conn, "user1", "alice", "allergic_to", "sesame seeds")
        # Very similar — "allergic_to sesame seeds" vs "allergic_to tree nut"
        ...
        # Actually let's check: the normalized forms are "allergic_to sesame seeds" and "allergic_to tree nut"
