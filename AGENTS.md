...
**Ansible**: role at `deploy/ansible/` (symlinked from `ansible-server/roles/istota/`). When adding config fields, update `defaults/main.yml` + `templates/config.toml.j2`.
