...
├── transport/            # Transport seam: IncomingMessage, registry, ingest, TalkTransport + EmailTransport
├── email_poller.py       # IMAP polling + plus-address routing
├── talk_poller.py        # Nextcloud Talk long-polling (collect_talk_messages = TalkTransport inbound body)
