...
├── transport/            # Transport seam: IncomingMessage, registry, ingest, talk/ (TalkTransport), email/ (EmailTransport + inbound/outbound bodies)
