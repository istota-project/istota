...
Resource types: `calendar`, `folder`, `todo_file`, `email_folder`, `reminders_file`, `shared_file`, `ledger`, `invoicing`, `karakeep`, `monarch`, `miniflux`, `feeds`, `money` (legacy alias `moneyman` still accepted).
