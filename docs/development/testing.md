...
| Marker | Needs | Runner |
|---|---|---|
| `integration` | a live Nextcloud instance, Garmin credentials, or a running devbox whose exec server answers — see below | `uv run pytest -m integration` |
