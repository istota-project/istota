...
**Ansible role** (`deploy/ansible/`): Full automation. Jinja2 templates generate config, systemd services, nginx, logrotate, backups. The `ansible-server/roles/istota/` path is a symlink to `deploy/ansible/`.
