...
The recurring failure, found seven times now, each time by a control rather than by reading. The first five are from this tier. The last two are from the default suite, and they are here because the failure belongs to the shape of the test rather than to containers:
